...
class Program
{
    static void Main()
    {
        ...
        {
            new User { UserName = "Alice", Email = "alice@example.com", PhoneNumber = "1111111111" },
            new User { UserName = "Charlie", Email = "charlie@example.com", PhoneNumber = "2222222222" },
            new User { UserName = "Bob", Email = "bob@example.com", PhoneNumber = "3333333333" },
            new User { UserName = "David", Email = "david@example.com", PhoneNumber = "4444444444" },
            new User { UserName = "Eve", Email = "eve@example.com", PhoneNumber = "5555555555" },
        };
